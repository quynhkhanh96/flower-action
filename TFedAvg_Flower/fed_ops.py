...
from FTTQ import fed_ttq

class LocalUpdate(object):
    def __init__(self, client_name, train_iter, test_iter, wp_lists, args):
    ...
    def TFed_train(self, net):
        # train and update
        net_dict, wp_lists = fed_ttq(net, self.local_train, self.local_test, self.c_name, self.wp_lists, self.args)
        self.wp_lists = wp_lists
